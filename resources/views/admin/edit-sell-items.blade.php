    ...
    <section class="content">
        ...
        <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Edit Sell Items</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              @foreach($edit_sell_items as $items_on_sell)
              <form class="form-horizontal mt-3" method="post" action="/update-items-on-sell/{{$items_on_sell->id}}" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" selected="selected" class="form-control" id="inputEmail3" name="price" value="{{$items_on_sell->price}}" placeholder="" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Number</label>
                    <div class="col-sm-10">
                    <input type="text" selected="selected" class="form-control" id="inputEmail3" name="number" value="{{$items_on_sell->number}}" placeholder="" required>
                    </div>
                  </div>
                  <div class="form-group row">
