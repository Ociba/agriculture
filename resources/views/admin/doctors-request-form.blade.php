  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal mt-3" method="post" action="/save-doctor-request" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" selected="selected" class="form-control" id="inputEmail3" name="conditions"  placeholder="" required>
                    </div>
                  </div>
                  <div class="form-group row">
