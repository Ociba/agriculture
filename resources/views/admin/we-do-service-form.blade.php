    ...
    <section class="content">
        ...
        <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Create Service We Do</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal mt-3" method="post" action="/save-we-do-service" enctype="multipart/form-data">
              @csrf
                <div class="card-body">
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Subject</label>
                    <div class="col-sm-10">
                    <input type="text" selected="selected" class="form-control" id="inputEmail3" name="subject"  placeholder="" required>
                    </div>
                  </div>
                  <div class="form-group row">
