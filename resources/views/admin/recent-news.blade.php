                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard dataTables_wrapper dt-bootstrap table-responsive">
                                        <table class="table table-bordered table-hover file-export">
                                            ...
                                            <tbody>
                                            @foreach ($show_recent_news as $recent)
                                              <tr>
                                                  <td>{{ $recent->title }}</td>
                                                  <td>
                                                  ...
                                                  <a href="/display-edit-recent-news/{{ $recent->id }}" data-widget="edit" data-toggle="tooltip" title="edit recent news">
                                                  <span class="btn btn-success btn-xs">edit</span></a>
                                                  @endif
                                                  @if(in_array('Can delete recent news', auth()->user()->getUserPermisions()))
                                                  <a href="/delete-recent-news/{{ $recent->id }}" data-widget="deny" data-toggle="tooltip" title="delete recent news">
