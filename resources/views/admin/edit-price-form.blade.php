    ...
    <section class="content">
        ...
        <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Edit Report Market Prices</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              @foreach($edit_prices as $prices)
              <form class="form-horizontal mt-3" method="post" action="/update-price/{{$prices->id}}">
              @csrf
                <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" selected="selected" class="form-control" id="inputEmail3" name="market_name" value="{{$prices->market_name}}" placeholder="" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" selected="selected" class="form-control" id="inputEmail3" name="quantity" value="{{$prices->quantity}}" placeholder="" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Price</label>
                    <div class="col-sm-10">
                    <input type="text" selected="selected" class="form-control" id="inputEmail3" name="price" value="{{$prices->price}}" placeholder="" required>
                    </div>
                  </div>
                <!-- /.card-body -->
