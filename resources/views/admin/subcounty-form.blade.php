  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal mt-3" method="get" action="/save-subcounty">
              @csrf
                <div class="card-body">
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Sub County</label>
                    <div class="col-sm-10">
                    <input type="text" selected="selected" class="form-control" id="inputEmail3" name="subcunty"  placeholder="Enter Subcunty Name" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
