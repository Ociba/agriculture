...
<body>
   @include('frontlayouts.search')
    ...
    <section class="page-title-area bg_cover d-flex align-items-center" style="background-image: url(assets/images/sheep.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-content">
                        <h3 class="title">Sell & Buy</h3>
    ...
    @include('frontlayouts.buyer-item-details')
