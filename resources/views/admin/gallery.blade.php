                                        ...
                                        <table class="table table-bordered table-hover file-export">
                                            ...
                                            @foreach ($show_gallery as $index =>$gallery)
                                              <tr>
                                                  ...
                                                  <a href="/display-edit-gallery/{{ $gallery->id }}" data-widget="edit" data-toggle="tooltip" title="edit gallery">
                                                  <span class="btn btn-success btn-xs">edit</span></a>
                                                  @endif
                                                  @if(in_array('Can delete gallery', auth()->user()->getUserPermisions()))
                                                  <a href="/delete-gallery/{{ $gallery->id }}" data-widget="deny" data-toggle="tooltip" title="delete gallery">
