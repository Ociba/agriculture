...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('css/bootstrap-datepaginator.min.cs')}}">
    </head>
                                        ...
                                        <table class="table table-bordered table-hover file-export">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Sent By</th>
                                                    <th>Reported On</th>
                                                    @if(in_array('Can see my price action', auth()->user()->getUserPermisions()))
                                                    <th>Action</th>
                                                    @endif
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @if(in_array('Can edit my price', auth()->user()->getUserPermisions()))
                                                    <td>
                                                        ...
                                                        @endif
                                                        @if(in_array('Can delete my price', auth()->user()->getUserPermisions()))
